...
export function activate(context: vscode.ExtensionContext) {
    ...
    let disposable = vscode.commands.registerCommand('uecurlyformatter.curlyformat', () => {
...
function hasAutoTab() {
    return vscode.workspace.getConfiguration("uecurlyformatter").get("autoTabIndentation");
}
